...
var dlg = new Window('dialog', 'Grabcut Integration in Photoshop');

// Add text boxes
dlg.msgPnl = dlg.add('panel', [10, 40, 400, 100], 'Name of input and scribbles layers, and number of colors for dithering');
var textbox1 = dlg.msgPnl.add('edittext', [10, 15, 90, 35], 'input');
var textbox2 = dlg.msgPnl.add('edittext', [150, 15, 240, 35], 'scribbles');
var textbox3 = dlg.msgPnl.add('edittext', [290, 15, 350, 35], '64', {name: 'Number of Colors'});

// Add radio buttons
dlg.radioPnl = dlg.add('panel', [10, 110, 400, 250], 'Mode of segmentation'); // Add panel
...
dlg.btnPnl = dlg.add('panel', [10, 190, 400, 240]);
var okBtn = dlg.btnPnl.add('button', [70, 15, 170, 35], 'Ok', {name: 'ok'}); 
var cancelBtn = dlg.btnPnl.add('button', [230, 15, 330, 35], 'Cancel', {name: 'cancel'}); 

// Show the window
if (dlg.show() == 1)
{
    execute(dlg.radioPnl);
}
...
{
    app.system('python C:\\Users\\Administrator\\Desktop\\multi_grabcut\\reduce_color_space.py --numcolors ' + textbox3.text)
}
