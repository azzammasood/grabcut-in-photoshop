...
def main():
    ...
    parser.add_argument('--numcolors', type=int, help='Number of colors for dithering', default=64, required=False)
    args = parser.parse_args()

    target_image = AutoRough(image_path = r'C:\Users\Administrator\Desktop\multi_grabcut\data\Original.jpg',
                             numberOfColors = args.numcolors,
...
class AutoRough:
    ...
    def export_reduced_color_image(self, uniqueColors, quantizedColors, gif_image, aw, ah):
        ...
        gif_image.save(r"C:\Users\Administrator\Desktop\multi_grabcut\data\Reduced_Color_Image.png")
