...
from gaussian_segmentation import GaussianSegmentation
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help='use grabcut or custom segmentation based on gaussian mixture',
        required=False,
    )
...
def main():
    ...
    # if use_grabcut == True
    if args.use_grabcut == True:

        print("Mode: Grabcut")
        print("Iterations: ", args.iter)
        print("Gamma: ", args.gamma)
        print("Resolve Type: ", args.resolve_type)
        ...
        # segmenting image based purely on scribbles
        # using gaussian mixture calculated from scribble pixels
        print("Mode: Gaussian Segmentation")
        ...
        output_mask = GS.segment(im_BGR, scribbles)
