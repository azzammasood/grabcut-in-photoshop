...
close()
export_layer_as_png(scribbles_layer, "scribbles.png")
execute_grabcut()
...
function export_layer_as_png(layer_name, output_name)
{
    ...
    var idUsng = charIDToTypeID( "Usng" );
        ...
        desc2114.putPath( idIn, new File( "C:\\Users\\Administrator\\Desktop\\multi_grabcut\\multi_grabcut_v3\\data" ) );
...
function open_output(name1)
{
    ...
    desc789.putPath( idnull, new File( "C:\\Users\\Administrator\\Desktop\\multi_grabcut\\multi_grabcut_v3\\data\\" + name1 ) );
...
function export_layer_as_jpg(input_layer, output_layer)
{
    ...
    var idUsng = charIDToTypeID( "Usng" );
        ...
        var idIn = charIDToTypeID( "In  " );
        desc506.putPath( idIn, new File( "C:\\Users\\Administrator\\Desktop\\multi_grabcut\\mulit_grabcut_v3\\data" ) );
        var idovFN = charIDToTypeID( "ovFN" );
...
function export_layer_as_exr(layer_name, output_name)
{
    selectLayer(layer_name)
    ...
    desc463.putInteger( idDpth, 32 );
    var idMrge = charIDToTypeID( "Mrge" );
    desc463.putBoolean( idMrge, true );
    executeAction( idCnvM, desc463, DialogModes.NO );
}
...
function export_as_exr(name_of_file)
{
    ...
    var idIn = charIDToTypeID( "In  " );
    desc705.putPath( idIn, new File("C:\\Users\\Administrator\\Desktop\\multi_grabcut\\multi_grabcut_v3\\data\\" + name_of_file + ".exr" ) );
